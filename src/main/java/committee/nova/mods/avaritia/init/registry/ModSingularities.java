...
public class ModSingularities {
    ...
    public static final Singularity ALUMINUM = new Singularity(new ResourceLocation(Static.MOD_ID, "aluminum"), "singularity.avaritia.aluminum", new int[]{0xCACCDA, 0x9A9CA6}, "c:aluminum_ingots", false, true);
    public static final Singularity TIN = new Singularity(new ResourceLocation(Static.MOD_ID, "tin"), "singularity.avaritia.tin", new int[]{0xA0BEBD, 0x527889}, "c:tin_ingots", false, true);
    public static final Singularity BRONZE = new Singularity(new ResourceLocation(Static.MOD_ID, "bronze"), "singularity.avaritia.bronze", new int[]{0xD99F43, 0xBB6B3B}, "c:bronze_ingots", false, true);
    public static final Singularity SILVER = new Singularity(new ResourceLocation(Static.MOD_ID, "silver"), "singularity.avaritia.silver", new int[]{0xC0CDD2, 0x5F6E7C}, "c:silver_ingots", false, true);
    public static final Singularity LEAD = new Singularity(new ResourceLocation(Static.MOD_ID, "lead"), "singularity.avaritia.lead", new int[]{0x6C7D92, 0x323562}, "c:lead_ingots", false, true);
    public static final Singularity STEEL = new Singularity(new ResourceLocation(Static.MOD_ID, "steel"), "singularity.avaritia.steel", new int[]{0x565656, 0x232323}, "c:steel_ingots", false, true);
    public static final Singularity NICKEL = new Singularity(new ResourceLocation(Static.MOD_ID, "nickel"), "singularity.avaritia.nickel", new int[]{0xE1D798, 0xB1976C}, "c:nickel_ingots", false, true);
    public static final Singularity ELECTRUM = new Singularity(new ResourceLocation(Static.MOD_ID, "electrum"), "singularity.avaritia.electrum", new int[]{0xF5F18E, 0x9E8D3E}, "c:electrum_ingots", false, true);
    public static final Singularity INVAR = new Singularity(new ResourceLocation(Static.MOD_ID, "invar"), "singularity.avaritia.invar", new int[]{0xBCC5BB, 0x5D7877}, "c:invar_ingots", false, true);
    public static final Singularity PLATINUM = new Singularity(new ResourceLocation(Static.MOD_ID, "platinum"), "singularity.avaritia.platinum", new int[]{0x6FEAEF, 0x57B8BC}, "c:platinum_ingots", false, true);
